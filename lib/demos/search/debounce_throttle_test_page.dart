...
class _DebounceThrottleTestPageState extends State<DebounceThrottleTestPage> {
    ...
    return ListView(
      ...
      children: <Widget>[
        ...
        JhButton(
            ...
            onPressed: () {
              print('点击按钮-未处理');
              LdgProgressHUD.showText('点击按钮-未处理');
            }),
        ...
        JhButton(
            ...
            onPressed: JhCommonUtils.debounce2(() {
              print('防抖后 - 点击按钮-防抖2');
              LdgProgressHUD.showText('点击按钮-防抖2，2000ms');
            }, 2000)),
        const SizedBox(height: 15),
        JhButton(
          text: '按钮-节流1',
        ...
        JhButton(
          ...
          onPressed: JhCommonUtils.throttle2(() {
            print('节流后 - 点击按钮-节流2');
            LdgProgressHUD.showText('点击按钮-节流2，2000ms');
          }, 2000),
        ),
      ],
    );
  ...
  _clickDebounceBtn1() {
    print('防抖后 - 点击按钮-防抖1');
    LdgProgressHUD.showText('点击按钮-防抖1，1000ms');
  }

  _clickThrottleBtn1() {
    print('节流后 - 点击按钮-节流1');
    LdgProgressHUD.showText('点击按钮-节流1，2000ms');
  }
    ...
    return JhFormInputCell(
      ...
      inputCallBack: (value) {
        ...
        setState(() {
          _keyWord = value;
          // 其他操作
          LdgProgressHUD.showText('未处理 _keyWord : $value');
        });
      },
    );
  }
  ...
  _input2() {
    return JhFormInputCell(
      ...
      inputCallBack: JhCommonUtils.debounceInput((value) {
        ...
        LdgProgressHUD.showText('防抖2 _keyWord2 : $value');
        setState(() {
          _keyWord2 = value;
          // 其他操作
        });
  ...
  _inputCallBack1(value, isSubmitted) {
    ...
    LdgProgressHUD.showText('防抖1 _keyWord1 : $value');
    setState(() {
      _keyWord1 = value;
      // 其他操作
    });
