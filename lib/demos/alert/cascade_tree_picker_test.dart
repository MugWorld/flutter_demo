    ...
    return JhTextList(
        ...
        callBack: (index, str) {
          if (str == 'JhCascadeTreePicker-都是三列') {
            LdgCascadeTreePicker.show(context,
                data: treeData3,
                labelKey: 'label',
          ...
          if (str == 'JhCascadeTreePicker-不定列') {
            LdgCascadeTreePicker.show(context, data: treeData, labelKey: 'label', title: '请选择类型', splitString: ' / ',
          ...
          if (str == 'JhCascadeTreePicker-不定列-隐藏搜索') {
            LdgCascadeTreePicker.show(context, data: treeData, isShowSearch: false, labelKey: 'label', title: '请选择类型',
                clickCallBack: (selectItem, selectArr) {
              print(selectItem);
              print(selectArr);
              showText(selectItem);
          ...
          if (str == 'JhCascadeTreePicker-不定列-默认选中(三级)') {
            ...
            LdgCascadeTreePicker.show(context, data: treeData, values: values, valuesKey: 'value', title: '请选择类型',
                clickCallBack: (selectItem, selectArr) {
              print(selectItem);
              print(selectArr);
              showText(selectItem);
          ...
          if (str == 'JhCascadeTreePicker-不定列-默认选中(只有两级)') {
            ...
            LdgCascadeTreePicker.show(context, data: treeData, values: values, valuesKey: 'label', title: '请选择类型',
                clickCallBack: (selectItem, selectArr) {
              print(selectItem);
              print(selectArr);
              showText(selectItem);
          ...
          if (str == 'JhCascadeTreePicker-第一列长度为1') {
            LdgCascadeTreePicker.show(context, data: treeData4, title: '请选择类型', clickCallBack: (selectItem, selectArr) {
              print(selectItem);
              print(selectArr);
              showText(selectItem);
            });
          ...
          if (str == 'JhCascadeTreePicker-第一列长度为1-默认选中') {
            ...
            LdgCascadeTreePicker.show(context, data: treeData4, values: values, valuesKey: 'value', title: '请选择类型',
                clickCallBack: (selectItem, selectArr) {
              print(selectItem);
              print(selectArr);
              showText(selectItem);
...
void showText(str) {
  LdgProgressHUD.showText(str.toString());
}
