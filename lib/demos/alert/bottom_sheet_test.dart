...
import '/jh_common/widgets/ldg_bottom_sheet.dart';
    ...
    return JhTextList(
        ...
        callBack: (index, str) {
          if (str == 'JhBottomSheet-不带标题') {
            LdgBottomSheet.showText(context, dataArr: ['hello', 'world', '123'], clickCallback: (index, text) {
              print(index);
              print(text);
              showText(text);
            });
          ...
          if (str == 'JhBottomSheet-带标题') {
            LdgBottomSheet.showText(context, dataArr: ['hello', 'world', '123'], title: '请选择',
          ...
          if (str == 'JhBottomSheet-红色') {
            LdgBottomSheet.showText(context, title: '请选择操作', dataArr: ['保存本地'], redBtnTitle: '删除',
                clickCallback: (index, text) {
              print(index);
              print(text);
              showText(text);
...
void showText(text) {
  LdgProgressHUD.showText(text.toString());
